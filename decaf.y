...
formals :
    ...
    |
    tformals {$$=new_node; $$->type_ok=1; $$->type=C_FORMALS; $$->formals = malloc(sizeof (struct formals)); $$->formals->tformals = $1;};
    
type :
    TKINT {$$=new_node; $$->type_ok=1; $$->type=C_TYPE; $$->vtype = malloc(sizeof (struct type)); $$->vtype->is_basic = 1; $$->vtype->is_array=0; $$->vtype->btype = D_INT;}
    | 
    TKBOOL {$$=new_node; $$->type_ok=1; $$->type=C_TYPE; $$->vtype = malloc(sizeof (struct type)); $$->vtype->is_basic = 1; $$->vtype->is_array=0; $$->vtype->btype = D_BOOL;}
    | 
    TKDOUBLE {$$=new_node; $$->type_ok=1; $$->type=C_TYPE; $$->vtype = malloc(sizeof (struct type)); $$->vtype->is_basic = 1; $$->vtype->is_array=0; $$->vtype->btype = D_DOUBLE;}
    | 
...
expr :               /*NEED TO CHECK TYPE*/
    lvalue TOASSIGN expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_ASSIGN; $$->expr->constant= NULL; $$->expr->lvalue=$1; $$->expr->expr1=$3; $$->expr->expr2=NULL; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    ...
    |
    call {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_CALL; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=NULL; $$->expr->expr2=NULL; $$->expr->call=$1; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    TOLB expr TORB {$$=new_node; $$->type_ok=1; $$->expr=malloc(sizeof(struct expr)); $$->type=C_EXPR; $$->expr->expr_type=EXPR_PRIORITY; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$2; $$->expr->expr2=NULL; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    ...
    |
    expr TODIV expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_DIV; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$1; $$->expr->expr2=$3; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    expr TOIDIV expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_IDIV; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$1; $$->expr->expr2=$3; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    expr TOLT expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_LT; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$1; $$->expr->expr2=$3; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    expr TOLE expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_LE; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$1; $$->expr->expr2=$3; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    expr TOGT expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_GT; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$1; $$->expr->expr2=$3; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    expr TOGE expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_GE; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$1; $$->expr->expr2=$3; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    expr TOEQU expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_EQU; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$1; $$->expr->expr2=$3; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    expr TONE expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_NE; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$1; $$->expr->expr2=$3; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    expr TOAND expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_AND; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$1; $$->expr->expr2=$3; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    expr TOOR expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_OR; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$1; $$->expr->expr2=$3; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    TONOT expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_NOT; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=$2; $$->expr->expr2=NULL; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
    TKREADINTEGER TOLB TORB {$$=new_node; $$->type_ok=1; $$->type=C_EXPR; $$->expr=malloc(sizeof(struct expr)); $$->expr->expr_type=EXPR_READINTEGER; $$->expr->constant= NULL; $$->expr->lvalue=NULL; $$->expr->expr1=NULL; $$->expr->expr2=NULL; $$->expr->call=NULL; $$->expr->id=NULL; $$->expr->type=NULL;}
    |
...
ifstmt :
    ...
    |
    TKIF TOLB expr TORB stmt TKELSE stmt {$$=new_node; $$->type_ok=1; $$->type=C_IFSTM; $$->if_stm = malloc(sizeof(struct if_stm)); $$->if_stm->expr = $3; $$->if_stm->stm1 = $5; $$->if_stm->stm2=$7;};
    
whilestmt :
    TKWHILE TOLB expr TORB stmt {$$=new_node; $$->type_ok=1; $$->type=C_WHILESTM; $$->whilestm = malloc(sizeof(struct whilestm)); $$->whilestm->expr = $3; $$->whilestm->stm = $5;};

expr_or_not:
    %empty {$$=new_node; $$->type_ok=1; $$->type=C_EXPR_OR_NOT; $$->expr_or_not = malloc(sizeof(struct expr_or_not)); $$->expr_or_not->expr = NULL;}
    |
    expr {$$=new_node; $$->type_ok=1; $$->type=C_EXPR_OR_NOT; $$->expr_or_not = malloc(sizeof(struct expr_or_not)); $$->expr_or_not->expr = $1;};
    
forstmt :
    TKFOR TOLB expr_or_not TPSEP expr TPSEP expr_or_not TORB stmt{$$=new_node; $$->type_ok=1; $$->type=C_FORSTM; $$->forstm = malloc(sizeof(struct forstm)); $$->forstm->expr_or_not1=$3; $$->forstm->expr=$5; $$->forstm->expr_or_not2=$7; $$->forstm->stm=$9;};
    
returnstmt :
    TKRETURN expr_or_not TPSEP {$$=new_node; $$->type_ok=1; $$->type=C_RETSTM; $$->returnstm = malloc(sizeof(struct returnstm)); $$->returnstm->expr_or_not=$2;};

breakstmt :
    TKBREAK TPSEP {$$=new_node; $$->type_ok=1; $$->type=C_BREAKSTM; $$->i_val=0;};

printstmt :
    TKPRINT TOLB exprss TORB TPSEP {$$=new_node; $$->type_ok=1; $$->type=C_PRINTSTM; $$->printstm = malloc(sizeof(struct printstm)); $$->printstm->expr=$3;};
...
stmt :
    ...
    |
    whilestmt {$$=new_node; $$->type_ok=1; $$->type=C_STM; $$->stm = malloc(sizeof(struct stm)); $$->stm->stm_type=STM_WHILE; $$->stm->s_stm=$1;}
    |
    forstmt {$$=new_node; $$->type_ok=1; $$->type=C_STM; $$->stm = malloc(sizeof(struct stm)); $$->stm->stm_type=STM_FOR; $$->stm->s_stm=$1;}
    |
    breakstmt {$$=new_node; $$->type_ok=1; $$->type=C_STM; $$->stm = malloc(sizeof(struct stm)); $$->stm->stm_type=STM_BREAK; $$->stm->s_stm=$1;}
    |
    returnstmt {$$=new_node; $$->type_ok=1; $$->type=C_STM; $$->stm = malloc(sizeof(struct stm)); $$->stm->stm_type=STM_RET; $$->stm->s_stm=$1;}
    |
    printstmt {$$=new_node; $$->type_ok=1; $$->type=C_STM; $$->stm = malloc(sizeof(struct stm)); $$->stm->stm_type=STM_PRINT; $$->stm->s_stm=$1;}
    |
    stmtblock {$$=new_node; $$->type_ok=1; $$->type=C_STM; $$->stm = malloc(sizeof(struct stm)); $$->stm->stm_type=STM_BLOCK; $$->stm->s_stm=$1;};
...
field :
    ...
    |
    funcdefine {$$=new_node; $$->type_ok=1; $$->type=C_FIELD; $$->field = malloc(sizeof(struct field)); $$->field->is_vardefine=0; $$->field->funcdefine=$1;};
...
define :
    ...
    |
    funcdefine {$$=new_node; $$->type_ok=1; $$->type=C_DEFINE; $$->define = malloc(sizeof(struct define)); $$->define->define_type=DEFINE_FUNC; $$->define->s_define=$1;}
    |
    classdefine {$$=new_node; $$->type_ok=1; $$->type=C_DEFINE; $$->define = malloc(sizeof(struct define)); $$->define->define_type=DEFINE_CLASS; $$->define->s_define=$1;}
    |
